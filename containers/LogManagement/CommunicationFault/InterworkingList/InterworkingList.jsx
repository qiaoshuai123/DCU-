...
class InterworkingList extends Component {
  constructor(props) {
    ...
    this.logList = '/DCU/connectFault/connectFaultListByPage'
    this.exportUrl = '/DCU/connectFault/exportConnectFaultList'
    this.logListParams = {
      endTime: '',
      faultType: null,
      keyword: '',
    ...
    return (
      <div className={styles.syetem_bg} ref={(input) => { this.userLimitBox = input }}>
        <div className={styles.syetem_title}>
          <div className={styles.syetem_titleLeft}>通讯故障</div>
        </div>
