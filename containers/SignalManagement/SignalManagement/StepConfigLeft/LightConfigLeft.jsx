      ...
      <div>
        {
          lightPicLists.length > 0 && lightPicLists.map((item, i) => {
            return <ImgEvent {...this.props} key={'light'+item.id} isMoveFlag={this.props.isMoveFlag} isClick={this.props.isClick} imgMsg={item} typeUrl={'lampgroup'} popLayerShowHide={this.popLayerShowHide} />
          })
        }
      </div>
    )
