...
class UserManagement extends Component {
  constructor(props) {
    ...
    this.listUrl = '/DCU/sys/user/list' // 获取列表
    this.deptUrl = '/DCU/sys/dept/list' // 获取用户组
    this.deleteUrl = '/DCU/sys/user/delete' // 删除
    this.roleUrl = '/DCU/sys/role/list' // 获取角色
    this.userUrl = '/DCU/sys/user/getUser'
    this.saveUrl = '/DCU/sys/user/save'
    this.updateUrl = '/DCU/sys/user/update'
    this.resetPassUrl = '/DCU/sys/user/resetPassword'
  }
  componentDidMount = () => {
    // 获取用户列表
    this.getSystemList()
